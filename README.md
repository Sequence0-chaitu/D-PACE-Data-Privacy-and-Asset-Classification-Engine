...
After `docker compose up -d`, open **http://localhost:3000** (admin / admin).

Three panels are provisioned automatically:
...
│   └── report/
│       └── exporter.py         # JSON/CSV report generation
├── rules/
...
> **Disclaimer:** D-PACE is a compliance *aid*, not a legal guarantee. Always engage qualified legal counsel for formal GDPR / PCI DSS compliance assessments.
